...
const SettingsPage = () => {
    ...
    const handleSaving = async(e) => {
        ...
        // query
        const checkNewName = query(collection(firebase_db,'users'), where('name',"==", newName)) // query the name
        const checkNewEmail = query(collection(firebase_db,'users'), where('email',"==", newEmail))// query the email
        const checkBothInfo = query(collection(firebase_db,'users'), where('email','==', newEmail), where('name', '==', newName))// query name && email
    ...
    return(
        <>
            <div className="setting__wrapper">
                ...
                <SettingModal modal={modal? true : false} />
