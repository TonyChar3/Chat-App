        ...
        <form onSubmit={logIn}>
          <h2>Sign-In</h2>
            <div className="userName__wrapper">
              ...
              <input type="email" name="username" id="userNameInput" onChange={(e) => handlEmailChange(e.target.value)} />
            </div>
            <div className="password__wrapper">
              <label htmlFor="password">Password:</label>
              <input type={showPasswrd? "text" : "password"} id="passWrdInput" onChange={(e) => handlePasswordChange(e.target.value)} />
